...
//			response.sendRedirect(request.getContextPath()+"/study/1026/test11Res.jsp?name="+name+"&age="+age+"&gender="+gender+"&hobby="+gender+"&job="+job); 
			...
			String viewPage = "/study/1026/test11Res.jsp";    // study 앞에 있는  /(슬레쉬)는 wabapp을 의미함.
