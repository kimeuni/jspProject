...
<%
	...
	pageContext.setAttribute("mid", mid);  /* 이걸 적어줘야 EL표기법으로 값을 같을 수 있다. */
%>
<!DOCTYPE html>
<html>
<head>
	...
	<script>
		...
		let viewPage = "";
		if('${mSw}' == 'No'|| '${mSw}' == 'null' || '${mid}' == 'null' || '${mid}' == ''){
...
<div class="container">
	...
	<div id="header" class="text-center" style="background-color: skyblue">
		<%@ include file="nav2.jsp" %>   <!-- 같은 경로에 있기 때문에 nav.jsp라고만 적어도 된다 -->
		<p class="text-right">${mid}님 로그인 중이십니다.</p>
	</div>
	<p><br/></p>
