...
<div class="container">
	...
	<form name="myform" method="post" action="boardInputOk.bo" >
		<table class="table table-bordered">
			...
			<tr>
				<th>글제목</th>
				<td><input type="text" name="title" id="title" placeholder="글제목을 입력하세요." required autofocus class="form-control"/></td>
			</tr>
			<tr>
				<th>이메일</th>
			...
			<tr>
				<th>글내용</th>
				<td><textarea rows="8" name="content" id="content" class="form-control" required ></textarea></td>
			</tr>
			<tr>
				<th>공개여부</th>
				<td>
